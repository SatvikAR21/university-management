...
public class ADDTEACHER extends JFrame implements ActionListener
{
    ...
    //NOW SINCE HERE THE EMPID IS UNEDITABLE THEREFORE WE ARE HERE MAKING A LABEL FOR OUR EMPID

    JLabel labelempid;
    //HERE NOW WE ARE GENERATING THE RANDOM EMPID
    ...
    ADDTEACHER()
    {
        ...
        labelempid=new JLabel("1003"+first4);
        labelempid.setBounds(220,200,200,30);
